...
void Manager::showSortedPassengersBySortOption(ostream &ostream1, const std::string &sortOption, unsigned int min,
                                               unsigned int max) {
...
void Manager::showSortedFlightsBySortOption(ostream &ostream1, const string &sortOption, flightNumber min,
                                            flightNumber max) {
...
void Manager::showSortedPlanesBySortedOption(ostream &ostream1, const std::string &sortOption, const planePlate &min,
...
void Manager::createPassenger(const string &Pname, Date birth) {
...
void
Manager::createFlight(const Date &departureDate, const Time &departureTime, const float &duration, std::string origin,
                      std::string destiny) {
    ...
    auto it = planes.begin() + minPlaneUsage;

    list<unsigned> temp_list = it->getFlightPlan();

    temp_list.push_back(newID);

    it->setFlightPlan(temp_list);

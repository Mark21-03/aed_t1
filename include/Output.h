...
namespace out {
    ...
    inline void flights(ostream &ostream1, ForwardIterator it) {
    ...
    template<typename ForwardIterator>
    inline void passenger(ostream& ostream1, ForwardIterator it) {
    ...
    template<typename ForwardIterator>
    inline void planes(ostream& ostream1, ForwardIterator it) {
        ostream1 << it->getNumberPlate() << '\t' << it->getType() << '\t' << it->getCapacity() << "\t\t"<<it->getFlightPlan().size()<<'\n';
    }

    void headerServices(ostream& ostream1);
    template<typename ForwardIterator>
    inline void services(ostream& ostream1, ForwardIterator it){

...
class Menu {
     ...
     */
    const vector<void (Menu::*)()> createFuncs = {&Menu::funcCreatePassenger, &Menu::funcCreatePlane,
                                                  &Menu::funcCreateFlight, &Menu::funcCreateService,
                                                  &Menu::addNewTransport};
    /**
     * A vector of pointers to class members. The vector represents the reads methods in the class.
     */
    const vector<void (Menu::*)()> readFuncs = {&Menu::funcReadPassenger, &Menu::funcReadPlane, &Menu::funcReadFlight,
                                                &Menu::funcReadService, &Menu::showNearbyTransports};
    /**
     * A vector of pointers to class members. The vector represents the updates methods in the class.
     */
    const vector<void (Menu::*)()> updateFuncs = {&Menu::funcUpdatePassenger, &Menu::funcUpdatePlane,
                                                  &Menu::funcUpdateFlight, &Menu::funcUpdateService,
                                                  &Menu::updateTransports};
    /**
     * A vector of pointers to class members. The vector represents the deletes methods in the class.
     */
    const vector<void (Menu::*)()> deleteFuncs = {&Menu::funcDeletePassenger, &Menu::funcDeletePlane,
                                                  &Menu::funcDeleteFlight, &Menu::funcDeleteService,
                                                  &Menu::removeNearbyTransport};
